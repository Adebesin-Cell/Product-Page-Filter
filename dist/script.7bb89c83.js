...
exports.renderPageResults = exports.filterProducts = exports.data = void 0;
var data = {
  search: {
    page: 1,
    resultPerPage: 10,
...
var renderPageResults = function renderPageResults() {
  var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : data.search.page;
  data.search.page = page;
  var start = (page - 1) * data.search.resultPerPage;
  var end = page * data.search.resultPerPage;
};

exports.renderPageResults = renderPageResults;
...
var View = /*#__PURE__*/function () {
  ...
  _createClass(View, [{
    ...
    value: function render(data) {
      ...
      var markup = this._generateMarkup(); // this._clear();
...
var PreviewView = /*#__PURE__*/function (_View) {
  ...
  function PreviewView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_container", "");
  ...
  _createClass(PreviewView, [{
    ...
    value: function _generateMarkup() {
      return "\n        <div class=\"product__item\">\n            <div class=\"product__card\">\n                <div class=\"product__image-box\">\n                    <img\n                    src= ".concat(this._data.img, "\n                    alt=\"").concat(this._data.name, "\"\n                    class=\"product__image\"\n                    />\n                </div>\n                <div class=\"product__detail\">\n                    <p class=\"product__name\">").concat(this._data.name, "</p>\n                    <p class=\"product__price\">$").concat(this._data.price, "</p>\n                </div>\n            </div>\n        </div>\n    ");
    }
  }]);
...
},{"./View":"Js/views/View.js"}],"Js/views/productView.js":[function(require,module,exports) {
"use strict";
...
var ProductView = /*#__PURE__*/function (_View) {
  ...
  function ProductView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_container", document.querySelector(".product__list"));
...
exports.default = _default;
},{"./View":"Js/views/View.js","./previewView":"Js/views/previewView.js"}],"Js/views/filterView.js":[function(require,module,exports) {
"use strict";
...
var FilterView = /*#__PURE__*/function (_View) {
  ...
  function FilterView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_FormInput", document.querySelector(".form__input"));
...
var _default = new FilterView();

exports.default = _default;
},{"./View":"Js/views/View.js"}],"Js/views/categoryView.js":[function(require,module,exports) {
"use strict";
...
var CategoryView = /*#__PURE__*/function (_View) {
  ...
  function CategoryView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_container", document.querySelector(".filter"));

    return _this;
  }

  _createClass(CategoryView, [{
    key: "addCategoryHandler",
    value: function addCategoryHandler(handler) {
...
var _default = new CategoryView();

exports.default = _default;
},{"./View":"Js/views/View.js"}],"Js/script.js":[function(require,module,exports) {
"use strict";

var model = _interopRequireWildcard(require("./model"));

var _productView = _interopRequireDefault(require("./views/productView"));

var _filterView = _interopRequireDefault(require("./views/filterView"));

var _categoryView = _interopRequireDefault(require("./views/categoryView"));
...
var controlFilter = function controlFilter(data) {
  var item = model.data.search.products.filter(function (product) {
...
var controlCategoryFilter = function controlCategoryFilter(category) {
  ...
  if (category === "watches") {
    ...
    _productView.default.render(items);
  }
...
init();
},{"./model":"Js/model.js","./views/productView":"Js/views/productView.js","./views/filterView":"Js/views/filterView.js","./views/categoryView":"Js/views/categoryView.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/script.7bb89c83.js.map